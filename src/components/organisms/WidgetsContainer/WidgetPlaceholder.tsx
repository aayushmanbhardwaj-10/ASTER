...
const WidgetPlaceholder: React.FC<WidgetPlaceholderProps> = ({
  ...
  const getSizeConfig = useCallback((size: string) => {
  ...
  const sizeConfig = useMemo(() => getSizeConfig(widget.size), [widget.size, getSizeConfig]);
          ...
          <div className={styles.widgetEdit}>
            <div className={styles.widgetEdit}>
              ...
              <div className={styles.widgetEditActions}>
                <button onClick={handleSave} className={styles.widgetEditBtn}>
                  Save
                </button>
                <button onClick={handleCancel} className={styles.widgetEditBtn}>
                  Cancel
                </button>
              </div>
            </div>
        ...
        {widget.type === 'market-overview' && (
          <>
            <div className={styles.widgetContentItem}>
              ...
              <div className={`${styles.widgetChange} ${styles.positive}`}>
                +0.45%
              </div>
            </div>
          </>
        ...
        {widget.type === 'watchlist' && (
          <>
            ...
            <div className={styles.widgetContentItem}>
              ...
              <div className={`${styles.widgetChange} ${styles.negative}`}>
                -0.3%
              </div>
            </div>
          </>
